...
-- `User`
INSERT INTO `User` (email, name, pin) VALUES('spmatthews03@gmail.com', 'Sean Matthews', 1234);

-- Corkboard
INSERT INTO corkboard ( title, visibility, owner_email, category_type) VALUES ('Gardening', 0, 'spmatthews03@gmail.com', 'Home & Garden')

-- Private Corkboard
INSERT INTO private_corkboard( title, owner_email, password) VALUES ('Gardening', 'spmatthews03@gmail.com', 'secret')

-- Pushpin
INSERT INTO `pushpin` (`title`, `date_time`, `owner_email`, `url`, `description`, `tags`
 ('Gardening', '2018-11-08 00:00:00', 'spmatthews03@gmail.com', 'https://www.google.com/', 'Here are some of my favorite plants!', NULL);